 ...
 * 
 * Modifications by Gaël Jaffredo <http://www.jaffredo.com/>
 */
(function ($){
        ...
        var WorldMap = function (params)
        {
                ...
                this.label2 = jQuery('<div/>').addClass('jqvmap-label2').appendTo(jQuery('body'));
                        ...
                        if (e.type == 'mouseover')
                        {
                                ...
                                if(params.showTooltip)
                                {
                                        ...
                                        $.getJSON("js/clients.json", function(data) {
                                                ...
                                                if (!nbclients){labelText="aucun client"}
                                                else if (nbclients == 1){labelText="1 client"}
                                                else {labelText=nbclients+" clients"}
                                                map.label2.text(labelText);
                                        });
                ...
                if(params.showTooltip)
                {
                        params.container.mousemove(function (e){
                                ...
                                {
                                        map.label.css({
                                                left: e.pageX - (.5* map.labelWidth) - 8,
                                                top: e.pageY + 55 - map.labelHeight
                                        });
                                        map.label2.css({
                                                left: e.pageX - (.5* map.labelWidth) - 8,
                                                top: e.pageY + 55 + map.labelHeight,
                                                width : map.labelWidth
                                        });
                                }
                        });
                }
